...
const NameBadge = ({name}) => {
    return(
            <View style={styles.nameChip}>
                <Image style={styles.nameBadge} source={require("../../assets/icons/user.png")}/>
...
const PropertyBadge = ({property}) => {
    return(
            <View style={styles.propertyChip}>
                <Image style={styles.propertyBadge} source={require("../../assets/icons/user.png")}/>
...
const StartTime = () => {
    ...
    const handleConfirm = (startTime) => {
      ...
      setTime(startTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true }))
