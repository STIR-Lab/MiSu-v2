...
class HomeScreen extends React.Component {
        ...
        >
          ...
          >
            {navigation.getParam("name") != null
              ? navigation.getParam("name").slice(0, 18)
              : "..."}
          </Text>
        </TouchableOpacity>
      </View>
  ...
  render() {
    ...
    if (
      (this.props.hubInfoData.hub_email == null ||
        this.props.hubInfoData.hub_email == "") &&
        ...
        <View style={appStyle.container}>
          <View style={{ width: 240, alignItems: "center" }}>
            ...
            <AppText style={{ marginTop: 20, fontSize: 16 }}>
              If you own a hub, register above.
            </AppText>
        ...
        >
          ...
          {this.state.refreshing == false && (
            <View style={[appStyle.container, { flex: 1 }]}>
              ...
              {this.props.hubInfoData.hub_email != null &&
                this.props.hubInfoData.hub_email != "" && (
                  <HubCard
                    name={this.props.sessionData.name}
                    sharedAccounts={
                      this.props.sharedAccountsData.sharedAccounts
                    }
              ...
              Array.isArray(this.props.sharedDevicesData.devices)
              ...
              {this.state.usageLogs.length > 0 ? (
                <View
                  style={[
                    appStyle.container,
                    { padding: 0, flex: 1, alignSelf: "stretch" },
                  ]}
                >
                  <TouchableOpacity
